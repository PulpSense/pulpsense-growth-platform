...
import { DeferredLoopVideo } from "./DeferredLoopVideo";
...
const comparisonRows = [
  [
    "Speed",
    "Often 2-4 weeks with briefs, shipping, filming, and edits",
    "10 variations delivered in 2 business days after assets",
  ],
  [
    "Starting point",
    "Usually starts from new concepts or creator interpretation",
    "Starts from a paid-social ad that already works",
  ],
  [
    "Your time",
    "Briefing, chasing, reviewing, and editing back-and-forth",
    "Bring the winner. We map, produce, QA, and deliver",
  ],
  [
    "Guarantee",
    "Usually pay regardless of usable output",
    "Usable creative after one revision pass or refund",
  ],
];
...
const SectionLabel = ({ children }: { children: React.ReactNode }) => (
  <p className="mb-4 text-xs font-medium tracking-[0.35em] text-[#8A8F98] uppercase">
    {children}
  </p>
);
...
const PrimaryCta = ({
  ...
  placement: "hero" | "proof" | "mechanism" | "faq" | "final";
  className?: string;
}) => (
  <a
    href={CALL_URL}
    onClick={() => trackFunnelEvent("cta_clicked", { placement })}
...
const AvatarOutputMockup = ({ video }: { video?: ReactNode }) => (
  <div className="relative mx-auto w-full max-w-[520px] rounded-[28px] border border-white/10 bg-[#0F1011]/95 p-4 shadow-[0_30px_90px_rgba(0,0,0,0.55)] backdrop-blur lg:max-w-[660px] lg:p-3">
    ...
    <div className="mb-4 flex items-center justify-between border-b border-white/10 pb-4 lg:mb-3 lg:pb-3">
      <div>
        <p className="text-xs tracking-[0.28em] text-[#8A8F98] uppercase">
          Creative lab
        </p>
        <p className="mt-1 text-sm font-medium text-[#F7F8F8]">
          Winner Avatar Multiplier
        </p>
      </div>
    ...
    <div className="grid gap-3 lg:grid-cols-[0.9fr_1.65fr] lg:gap-2.5">
      <div className="rounded-2xl border border-white/10 bg-black/80 p-3 lg:p-2.5">
        <div className="relative min-h-[460px] overflow-hidden rounded-xl border border-white/10 bg-black lg:min-h-[360px]">
          ...
          <div className="absolute top-3 left-3 rounded-full bg-black/55 px-2 py-1 text-[10px] tracking-[0.2em] text-white/80 uppercase backdrop-blur">
            Winner
          </div>
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-3 lg:gap-2.5">
        {exampleVideos.slice(1, 7).map((video) => (
          ...
          >
            <img
              src={`/creative-multiplier-sprint/images/${video.id}.webp`}
              alt={video.title}
...
export const VideoExamplesSection = () => (
  <section
    id="proof"
    className="border-b border-white/10 bg-[#08090A] px-5 py-14 md:px-8 lg:py-20"
  >
    <div className="mx-auto max-w-7xl">
      <div className="mb-10 flex flex-col justify-between gap-5 md:flex-row md:items-end">
        <div>
          <SectionLabel>Proof examples</SectionLabel>
          <h2 className="max-w-3xl text-4xl leading-[1.02] font-medium tracking-[-0.055em] md:text-5xl">
            Real vertical examples, ready to inspect.
          </h2>
          <p className="mt-4 max-w-2xl text-lg leading-8 text-[#AEB6C2]">
            Short-form clips in the same style this sprint is designed to
            multiply: hooks, testimonials, demos, explainers, and creator-led
            product angles.
          </p>
        </div>
        <PrimaryCta placement="proof" className="md:self-end">
          Apply now
        </PrimaryCta>
      </div>
    ...
    <>
      ...
      <main className="min-h-screen bg-[#010102] text-[#F7F8F8] [font-feature-settings:'cv01','ss03']">
        <section id="hero" className="relative overflow-hidden bg-[#010102]">
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-8 px-5 py-5 md:px-8 md:py-8 lg:min-h-[540px] lg:grid-cols-[0.92fr_1.08fr] lg:gap-14 lg:pt-10 lg:pb-4">
            <div>
              <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-3 py-2 text-[11px] leading-none font-medium text-[#D0D6E0] sm:mb-5 sm:text-xs">
              ...
              <h1 className="max-w-4xl text-[2.15rem] leading-[0.96] font-medium tracking-[-0.045em] text-[#F7F8F8] sm:text-5xl md:text-6xl md:leading-[0.95] md:tracking-[-0.06em] lg:text-7xl">
                <span className="sm:hidden">
                  <span className="text-[#FF6B1A]">10 avatar videos</span> from
                  one winning ad.
                </span>
                <span className="hidden sm:inline">
                  Turn one winning ad into{" "}
                  <span className="text-[#FF6B1A]">10 avatar videos</span> in 2
                  business days.
                </span>
              </h1>

              <p className="mt-3 max-w-2xl text-[0.93rem] leading-6 tracking-[-0.01em] text-[#AEB6C2] md:mt-5 md:text-lg md:leading-7">
                Give your media buyer 10 new versions before the current winner
                burns out.
              </p>
        ...
        <section className="border-b border-white/10 bg-[#08090A] px-5 py-14 md:px-8 lg:py-20">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
              <div>
                <h2 className="text-4xl leading-[1.02] font-medium tracking-[-0.055em] md:text-5xl">
                  Your winning ad does not need a new idea. It needs new faces.
                </h2>
                <p className="mt-5 max-w-xl text-lg leading-8 text-[#AEB6C2]">
                  We keep the winning sales argument intact and change the
                  visible variables around it before audience fatigue turns into
                  climbing CPA.
                </p>
              </div>
        ...
        <section className="px-5 py-14 md:px-8 lg:py-20">
          <div className="mx-auto max-w-7xl">
            <div className="mb-10 flex flex-col justify-between gap-6 md:flex-row md:items-end">
              ...
              <PrimaryCta placement="mechanism" className="md:self-end">
                Apply now
              </PrimaryCta>
            </div>
            ...
            <div className="grid gap-3 lg:grid-cols-4">
              {processSteps.map((step) => (
                <div
                  key={step.label}
                  className="relative rounded-2xl border border-white/10 bg-[#0F1011] p-5"
                >
                  ...
                  <h3 className="text-xl leading-tight font-medium tracking-[-0.04em] text-white">
                    {step.title}
                  </h3>
                  <p className="mt-3 text-sm leading-6 text-[#8A8F98]">
                    {step.body}
        ...
        <section className="bg-[#08090A] px-5 py-14 md:px-8 lg:py-20">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-10 overflow-hidden rounded-3xl border border-white/10 bg-[#0F1011]">
              <div className="grid grid-cols-1 border-b border-white/10 bg-white/[0.03] text-xs tracking-[0.22em] text-[#8A8F98] uppercase md:grid-cols-[0.7fr_1fr_1fr]">
                <div className="p-4">Variable</div>
                <div className="border-t border-white/10 p-4 md:border-t-0 md:border-l">
                  Traditional UGC batch
                </div>
                <div className="border-t border-[#FF6B1A]/25 bg-[#FF6B1A]/10 p-4 text-[#ffb28a] md:border-t-0 md:border-l">
              ...
              {comparisonRows.map(([feature, traditional, modern]) => (
                <div
                  key={feature}
                  className="grid grid-cols-1 border-b border-white/10 last:border-b-0 md:grid-cols-[0.7fr_1fr_1fr]"
                >
                  <div className="p-4 text-sm font-medium text-white">
                    {feature}
                  </div>
                  <div className="border-white/10 p-4 text-sm leading-6 text-[#8A8F98] md:border-l">
                    {traditional}
                  </div>
                  <div className="border-[#FF6B1A]/20 bg-[#FF6B1A]/[0.035] p-4 text-sm leading-6 text-[#D0D6E0] md:border-l">
                    {modern}
                  </div>
                </div>
              ))}
        ...
        <section id="output" className="px-5 py-14 md:px-8 lg:py-20">
          <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
            <div>
              ...
              <p className="mt-5 max-w-xl text-lg leading-8 text-[#AEB6C2]">
                You get a QA-led sprint deliverable built for paid-social
                testing. Not raw dashboard exports. Not random new concepts.
                Variations of the thing that already proved it can sell.
              </p>
              <div className="mt-6 rounded-2xl border border-emerald-400/20 bg-emerald-400/[0.055] p-5 text-sm leading-6 text-[#D0D6E0]">
                <p className="font-medium text-white">
                  Usable creative guarantee
                </p>
                <p className="mt-2 text-[#AEB6C2]">
                  If the final batch is not usable after one revision pass, we
                  refund your payment.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-white/10 bg-[#0F1011] p-5 shadow-[0_30px_90px_rgba(0,0,0,0.35)]">
              <div className="mb-5 flex items-center justify-between border-b border-white/10 pb-5">
                <div>
                  ...
                  <h3 className="mt-1 text-2xl font-medium tracking-[-0.045em] text-white">
                    Creative Multiplier Sprint
                  </h3>
                </div>
              ...
              <div className="space-y-3">
                {deliverables.map((item) => (
                  ...
                  >
                    <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#B94100] text-xs font-bold text-white">
                      ✓
                    </span>
              ...
              <div className="rounded-3xl border border-emerald-400/20 bg-emerald-400/[0.04] p-6">
                ...
                <div className="mt-6 space-y-3">
                  {goodFit.map((item) => (
                    <p
                      key={item}
                      className="rounded-xl border border-emerald-400/15 bg-black/20 p-4 text-sm text-[#D0D6E0]"
                    >
                      ✓ {item}
                    </p>
                  ))}
              ...
              <div className="rounded-3xl border border-red-400/20 bg-red-400/[0.035] p-6">
                ...
                <div className="mt-6 space-y-3">
                  {notFit.map((item) => (
                    <p
                      key={item}
                      className="rounded-xl border border-red-400/15 bg-black/20 p-4 text-sm text-[#D0D6E0]"
                    >
                      × {item}
                    </p>
                  ))}
        ...
        <section className="px-5 py-14 md:px-8 lg:py-20">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-end">
              <h2 className="max-w-2xl text-4xl leading-[1.02] font-medium tracking-[-0.055em] md:text-5xl">
                Why trust PulpSense with this?
              </h2>
              <p className="max-w-md text-sm leading-6 text-[#8A8F98]">
                Different projects, same operating principle: fast execution,
                clean systems, and no disappearing after the kickoff call.
              </p>
            </div>
            <div className="grid gap-4 lg:grid-cols-3">
              {testimonials.map((testimonial) => (
                <div
                  ...
                  className="rounded-3xl border border-white/10 bg-[#0F1011] p-6"
                >
                  <p className="text-base leading-7 text-[#D0D6E0]">
                    “{testimonial.quote}”
                  </p>
          ...
          <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              ...
              <div className="mt-8 hidden lg:block">
                <PrimaryCta placement="faq">Apply now</PrimaryCta>
              </div>
            </div>
            <div className="space-y-3">
              {faqs.map((faq) => (
                <details
                  key={faq.question}
                  className="group rounded-2xl border border-white/10 bg-[#0F1011] p-5 open:border-[#FF6B1A]/30"
                >
                  <summary className="cursor-pointer list-none text-lg font-medium tracking-[-0.03em] text-white">
                    <span className="flex items-center justify-between gap-4">
                      {faq.question}
                      <span className="text-[#FF6B1A] transition group-open:rotate-45">
                        +
                      </span>
                    </span>
                  </summary>
          ...
          <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
            <div className="lg:sticky lg:top-8">
              ...
              <p className="mt-5 text-lg leading-8 text-[#AEB6C2]">
                You do not need a full brief to apply. Answer the fit questions
                now; if it looks like a match, bring the winning ad to the call
                and we will map the variations with you.
              </p>
              <div className="mt-6 rounded-2xl border border-[#FF6B1A]/20 bg-[#FF6B1A]/[0.055] p-5 text-sm leading-6 text-[#D0D6E0]">
                <p className="font-medium text-white">
                  For the call, just have these nearby:
                </p>
                ...
                <p className="mt-4 text-[#AEB6C2]">
                  We handle the teardown, variation map, avatar direction, and
                  production plan.
                </p>
              </div>
            </div>
            ...
            <div className="overflow-visible rounded-[28px] border border-white/10 bg-[#0F1011] p-4 shadow-[0_30px_90px_rgba(0,0,0,0.45)] md:p-6">
              <Suspense
                fallback={
                  <div className="h-[620px] animate-pulse rounded-2xl bg-white/[0.04]" />
                }
              >
        ...
        <section className="px-5 py-14 md:px-8 lg:py-20">
          <div className="mx-auto max-w-5xl overflow-hidden rounded-[32px] border border-[#FF6B1A]/25 bg-[radial-gradient(circle_at_20%_0%,rgba(255,107,26,0.22),transparent_32%),linear-gradient(145deg,#111318,#050506)] p-8 text-center shadow-[0_30px_100px_rgba(0,0,0,0.45)] md:p-12">
            ...
            <h2 className="mx-auto max-w-3xl text-4xl leading-[1.02] font-medium tracking-[-0.055em] md:text-6xl">
              Got one ad that already works?
            </h2>
            <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-[#AEB6C2]">
              Let us see if it can become 10. No upload, no full brief, no
              strategy doc before booking.
            </p>
            <div className="mt-8">
              <PrimaryCta placement="final" className="px-7 py-4 text-base">
                Apply now
              </PrimaryCta>
            </div>
            <p className="mt-4 text-sm text-[#8A8F98]">
              Quick fit check first, so we only book calls where the sprint can
              actually help.
            </p>
          </div>
        </section>
        ...
        <footer className="border-t border-white/10 px-5 py-10 text-sm text-[#8A8F98] md:px-8">
          <div className="mx-auto max-w-7xl">
            <h3 className="text-base font-medium text-[#D0D6E0]">
              Performance Disclaimer
            </h3>
            <p className="mt-3 max-w-4xl leading-6">
              Creative output and advertising performance vary based on your
              offer, product, account history, audience, budget, media buying,
              platform policies, and market conditions. We do not guarantee
              ROAS, CPA, revenue, or ad account performance.
            </p>
            <p className="mt-2 max-w-4xl leading-6">
              The Creative Multiplier Sprint guarantees usable creative output
              after one revision pass, not paid-media results. Platform approval
              and compliance remain your responsibility.
            </p>
            <div className="mt-6 flex flex-wrap gap-4">
              <a href="#" className="hover:text-[#D0D6E0]">
                Privacy Policy
              </a>
              <a href="#" className="hover:text-[#D0D6E0]">
                Terms of Service
            ...
            <p className="mt-6">
              © {new Date().getFullYear()} PulpSense. All Rights Reserved.
            </p>
          </div>
        </footer>
