  ...
  return (
    <footer className="py-12">
      <div className="mx-auto max-w-4xl px-4">
        {/* Earnings disclaimer */}
        <div className="border-navy-700 mb-8 border-t pt-8">
        ...
        <div className="border-navy-700 flex flex-col items-center justify-between gap-4 border-t pt-8 text-center md:flex-row md:text-left">
