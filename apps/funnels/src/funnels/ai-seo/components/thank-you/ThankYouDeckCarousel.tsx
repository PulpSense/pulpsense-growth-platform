...
const slideDescriptions = [
  "Your Regional Visibility Audit is reserved. Review the next steps and the guarantee of 45 new calls in 90 days, or work continues free until the business gets them.",
  ...
  "The market is benchmarked across Google Maps, organic search, AI Overviews, and ChatGPT to identify competitors recommended first.",
  "The authority foundation is built across business information, technical structure, regional coverage, service content, citations, profiles, and reputation.",
  ...
  "A compliant reputation system requests honest customer feedback and makes genuine trust easier to see.",
  "Visibility expands and is maintained across weak markets and service lines as the competitive landscape changes.",
  "Reporting establishes a baseline and reviews visibility, completed work, priorities, and call growth.",
  "The client provides access and business context while the implementation and focused review calls are handled for them.",
  ...
  "The guarantee is 45 additional calls in 90 days, or work continues at no management fee until the agreed result is reached.",
