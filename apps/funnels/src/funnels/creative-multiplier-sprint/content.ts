...
export const creativeMultiplierContent = {
  banner:
    "Founder-led sprint capacity is limited. Price discussed on the fit call.",
  hero: {
    pill: "For ecommerce brands with proven paid-social winners",
    headline:
      "Turn one winning paid-social ad into 10 avatar videos in 2 business days.",
    subheadline:
      "Bring the winning ad. We handle the teardown, avatar map, production, QA, and delivery.",
    proofCaption:
      "One winning concept -> multiple launch-ready avatar variations",
  },
  proofStats: [
  ...
  proof: {
    ...
    cases: [
      {
        ...
        output:
          "10 avatar-led testimonials with the same offer, claim, CTA, and pacing",
    ...
    gallery: [
      ...
      {
        avatar: "/assets/images/avatars/avatar-2.avif",
        title: "Peer testimonial",
        niche: "Supplements",
      },
      {
        avatar: "/assets/images/avatars/avatar-3.avif",
      ...
      {
        avatar: "/assets/images/avatars/avatar-5.avif",
        title: "Expert explainer",
        niche: "Health",
      },
      {
        avatar: "/assets/images/avatars/avatar-6.avif",
      ...
      {
        avatar: "/assets/images/avatars/avatar-8.avif",
  ...
  problem: {
    ...
    body: "Creators take weeks. Editors can only remix old footage so much. Random new concepts are risky when the fastest path is usually more versions of what already works.",
    costs: [
  ...
  trust: {
    ...
    body: "Built by PulpSense, an AI and automation agency with official n8n and Make partner experience. This is a founder-led sprint, not access to another dashboard where your team has to prompt, edit, decide, QA, and export.",
    cards: [
  ...
  guarantee: {
    ...
    body: "If you do not feel the final creatives are usable after one revision pass, we refund your payment. No ROAS promises. No performance claims. Just usable creative output or your money back.",
  },
  faq: {
    label: "FAQ",
