...
| Route                                        | Purpose                                                     |
| -------------------------------------------- | ----------------------------------------------------------- |
| `/visibility-audit/law-firms/`                  | Lawyer campaign lander, qualification, contact, and booking |
| `/visibility-audit/law-firms/thank-you/`        | Lawyer post-booking instructions and proof                  |
| `/visibility-audit/dental-practices/`                  | Dentist campaign lander, qualification, contact, and booking |
| `/visibility-audit/dental-practices/thank-you/`        | Dentist post-booking instructions and proof                 |
