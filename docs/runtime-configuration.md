...
| ------------------------------------------------ | ------ | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- | ------------------------------- | ----------------------------------- |
| `PUBLIC_META_PIXEL_ID`                           | No     | Astro includes browser Pixel loading only when this build-time value is present.                                        | Unset or sandbox dataset in the build environment | Preview-only dataset            | Production dataset in launch ticket |
...
| `MILLION_VERIFIER_API_KEY`                       | Yes    | Enables server-side email verification; when absent, verification reports `skipped` and allows the visitor to continue. | `apps/funnels/.dev.vars`                          | Preview credential              | Production credential               |
